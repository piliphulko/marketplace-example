...
\COPY table_goods (name_goods, type_goods, info_goods) FROM 'C:\Users\pilip\go\src\github.com\piliphulko\marketplace-example\db\csv\table_goods.csv' DELIMITER ',' CSV HEADER;
...
\COPY table_warehouse_info (id_warehouse, name_warehouse, info_warehouse, country, city) FROM 'C:\Users\pilip\go\src\github.com\piliphulko\marketplace-example\db\csv\table_warehouse_info.csv' DELIMITER ',' CSV HEADER;
...
\COPY table_consignment (id_warehouse, id_vendor, id_goods, amount_goods_available, amount_goods_defect, goods_in_stock, arrival_date_goods, consignment_info, id_problem) FROM 'C:\Users\pilip\go\src\github.com\piliphulko\marketplace-example\db\csv\table_consignment.csv' DELIMITER ',' CSV HEADER;
...
--\i 'C:/Users/pilip/go/src/github.com/piliphulko/marketplace-example/db/csv/psql_import_csv.sql'