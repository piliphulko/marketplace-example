...
import (
	...
	pb "github.com/piliphulko/marketplace-example/internal/service/service-order-pay"
...
func main() {
	...
	lis, err := net.Listen(
		viper.GetString("SERVICE-ORDER-PAY.NETWORK_SERVER"),
		viper.GetString("SERVICE-ORDER-PAY.PORT"),
	)
	if err != nil {
		log.Fatal(err)
	}
